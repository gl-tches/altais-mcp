...
export function buildMlSecurityFinding(
  draft: MlSecurityFindingDraft,
  ...
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("ml_security", draft.rule, location, draft.evidence ?? ""),
    module: "ml_security",
    rule: draft.rule,
