...
export function buildSdlcFinding(draft: SdlcFindingDraft, filename: string | undefined): Finding {
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("sdlc", draft.rule, location, draft.evidence ?? ""),
    module: "sdlc",
    rule: draft.rule,
