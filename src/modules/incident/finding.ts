...
export function buildIncidentFinding(
  ...
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("incident", draft.rule, location, draft.evidence ?? ""),
    module: "incident",
    rule: draft.rule,
