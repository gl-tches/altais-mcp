...
export function buildIacFinding(draft: IacFindingDraft, filename: string | undefined): Finding {
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("iac", draft.rule, location, draft.evidence ?? ""),
    module: "iac",
    rule: draft.rule,
