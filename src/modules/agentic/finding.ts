...
export function buildAgenticFinding(
  draft: AgenticFindingDraft,
  ...
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("agentic", draft.rule, location, draft.evidence ?? ""),
    module: "agentic",
    rule: draft.rule,
