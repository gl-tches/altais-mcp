...
export function buildDataFinding(draft: DataFindingDraft, filename: string | undefined): Finding {
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("data", draft.rule, location, draft.evidence ?? ""),
    module: "data",
    rule: draft.rule,
