...
export function buildProtocolFinding(
  draft: ProtocolFindingDraft,
  ...
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("protocol", draft.rule, location, draft.evidence ?? ""),
    module: "protocol",
    rule: draft.rule,
