...
export function buildTestingFinding(
  draft: TestingFindingDraft,
  ...
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("testing", draft.rule, location, draft.evidence ?? ""),
    module: "testing",
    rule: draft.rule,
