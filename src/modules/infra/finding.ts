...
export function buildInfraFinding(draft: InfraFindingDraft, filename: string | undefined): Finding {
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("infra", draft.rule, location, draft.evidence ?? ""),
    module: "infra",
    rule: draft.rule,
