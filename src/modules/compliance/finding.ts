...
export function buildComplianceFinding(
  ...
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("compliance", draft.rule, location, draft.evidence ?? ""),
    module: "compliance",
    rule: draft.rule,
