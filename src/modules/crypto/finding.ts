...
export function buildCryptoFinding(draft: CryptoFindingDraft, source: string | undefined): Finding {
  const location: FindingLocation | undefined =
    source !== undefined
      ...
      : undefined;
  return {
    id: findingId("crypto", draft.rule, location, draft.evidence ?? ""),
    module: "crypto",
    rule: draft.rule,
