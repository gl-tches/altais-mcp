...
export function buildApiFinding(draft: ApiFindingDraft, filename: string | undefined): Finding {
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("api", draft.rule, location, draft.evidence ?? ""),
    module: "api",
    rule: draft.rule,
