// Shared Finding builder for runtime audits.
...
export function buildRuntimeFinding(
  draft: RuntimeFindingDraft,
  ...
  const location: FindingLocation | undefined =
    filename !== undefined
      ...
      : undefined;
  return {
    id: findingId("runtime", draft.rule, location, draft.evidence ?? ""),
    module: "runtime",
    rule: draft.rule,
